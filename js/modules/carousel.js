state.media = [
  {
    ...
    "name": "平台品牌宣传视频.mp4",
    "url": "",
    "poster": "./assets/banners/home-hero.png",
    "enabled": true
  },
  {
    "id": "i1",
    "type": "图片",
    "name": "行业无人机解决方案.jpg",
    "url": "./assets/icons/category-enterprise.png",
    "enabled": true
  },
  {
    "id": "i2",
    "type": "图片",
    "name": "专业飞手服务.jpg",
    "url": "./assets/icons/category-onsite.png",
    "enabled": true
  },
  {
    "id": "i3",
    "type": "图片",
    "name": "无人机培训报名.jpg",
    "url": "./assets/icons/category-agency.png",
    "enabled": false
  }
];
...
function carouselPage() {
  return panel("轮播内容配置", carouselConfigBody());
}
